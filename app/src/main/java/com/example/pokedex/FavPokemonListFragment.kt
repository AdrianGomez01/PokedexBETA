...
import com.example.pokedex.databinding.FragmentFavPokemonListBinding
...
class FavPokemonListFragment : Fragment() {
    ...
    private lateinit var favPokemonAdapter: FavPokemonAdapter
    ...
    private fun initRecView() {
        favPokemonAdapter = FavPokemonAdapter(
            favPokemons,
            { pos -> delFavPoke(pos) },
